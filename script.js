...
// Variáveis
let randomNumber = Math.round(Math.random() * fortuneCookies.length)
const cookieScreen = document.querySelector(".cookieScreen")
const messageScreen = document.querySelector(".messageScreen")
const message = document.querySelector(".boxMessage p")
const cookie = document.querySelector("#cookie")
const againBtn = document.querySelector("#openAgain")

// Eventos
cookie.addEventListener("click", cookieClick)
againBtn.addEventListener("click", openAgain)
...
function cookieClick() {
  ...
  message.textContent = fortuneCookies[randomNumber]
}
...
function openAgain() {
  ...
  randomNumber = Math.round(Math.random() * fortuneCookies.length)  
}